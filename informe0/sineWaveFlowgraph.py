...
class sineWaveFlowgraph(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Esto es una grafica", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Esto es una grafica")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SAW_WAVE, 1000, 1, 0, 0)
