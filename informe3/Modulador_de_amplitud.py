...
from Lab3 import Lab3  # grc-generated hier_block
...
class Modulador_de_amplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._ka_win = qtgui.RangeWidget(self._ka_range, self.set_ka, "Habilita carrier", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._ka_win)
        self._fc_range = qtgui.Range(50, 2.2e3, 1, 50, 200)
        self._fc_win = qtgui.RangeWidget(self._fc_range, self.set_fc, "Frecuencia carrier [MHZ]", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fc_win)
        self._GTX_range = qtgui.Range(0, 30, 1, 10, 200)
        self._GTX_win = qtgui.RangeWidget(self._GTX_range, self.set_GTX, "Ganancia del radio", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._Ac_range = qtgui.Range(0, 0.500, 10e-3, 125e-3, 200)
        self._Ac_win = qtgui.RangeWidget(self._Ac_range, self.set_Ac, "Amplitud carrier", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        # Connections
        ##################################################
        self.connect((self.Lab3_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.Lab3_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.Lab3_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_random_source_x_0, 0), (self.blocks_uchar_to_float_0, 0))
        self.connect((self.blocks_add_const_vxx_0, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.Lab3_0, 0))
